...
4. 🎯 **Based on SoTA Cross-encoders and other models**:
    ...
    - Below are the list of models supported as of now.
        ...
        * ce-esci-MiniLM-L12-v2 [FT on Amazon ESCI dataset](https://github.com/amazon-science/esci-data) (This is interesting because most models are FT on MSFT MARCO Bing queries)
    - Models in roadmap:
        * InRanker
